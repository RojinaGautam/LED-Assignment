...
def create_sidebar(master, switch_view):
    ...
    buttons = [
        ("Dashboard", "./images/button-icons/dashboard.png", lambda: switch_view("dashboard")),
        ("Courses", "./images/button-icons/dashboard.png", lambda: switch_view("courses")),
        ("Tasks", "./images/button-icons/teacher.png", lambda: switch_view("tasks")),
        ("Students", "./images/button-icons/bank.png", lambda: switch_view("students")),
        ("Settings and profile", "./images/button-icons/setting-2.png", lambda: switch_view("settings")),
        ("Attendance", "./images/button-icons/chart-square.png", lambda: switch_view("attendance"))
    ]
