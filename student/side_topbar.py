...
def create_sidebar(master, switch_view):
    ...
    buttons = [
        ...
        ("Profile", "./images/button-icons/dashboard.png", lambda: switch_view("profile")),
        ("Tasks", "./images/button-icons/teacher_copy.png", lambda: switch_view("tasks")),
        ("Attendance", "./images/button-icons/bank.png", lambda: switch_view("attendance")),
